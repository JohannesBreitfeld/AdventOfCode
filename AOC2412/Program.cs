...
for (int i = 0; i < rows; i++)
{
    for (int j = 0; j < cols; j++)
    {
        ...
        totalPrice += price;
        //Console.WriteLine($"Character: {c} Area: {area}, Sides: {sides}, Price: {price}");
    }
}
Console.WriteLine(totalPrice);

//foreach (var position in sidesMapping)
//{
//    Console.Write($"{position.Key} : ");
//    for (int i = 0; i < position.Value.Count; i++)
//    {
//        Console.Write($"{position.Value[i]}, ");
//    }
//    Console.WriteLine();
//}
